...
/**
* @preserve
* Email Linker ${version.replace()} - WebComponent to user navigation to their email
* License: Apache-2.0
* Repo   : https://github.com/Rhosys/email-linker
...
export default {
  mode: 'production',
  entry: './src/email-linker.js',
  devtool: 'cheap-module-source-map',
  output: {
    path: path.join(__dirname, 'dist', 'browser'),
    filename: 'email-linker.min.js',
    publicPath: '',
  },
  optimization: {
    minimizer: [
